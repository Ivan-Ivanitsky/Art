...
const modals = () => {
    ...
    function modal(triggerModalOpen, triggerModal, triggerModalClose, present) {
        ...
        open.forEach(item => {                          // open Modal - btn
            item.addEventListener('click', (e) => {
                ...
                window.forEach(item =>{                 // close all modal 
            ...
            close.addEventListener('click', () => {             //  this functinon close modal  after click btn_close
                window.forEach(item =>{                         
                    item.style.display = 'none';
                })
    ...
    function scrollPageYOffset(selector,present){
        window.addEventListener('scroll',()=>{
            ...
            const scroll = Math.max(document.documentElement.clientHeight,document.body.offsetHeight);
    ...
    timeModal('.popup-consultation  ',6000)
